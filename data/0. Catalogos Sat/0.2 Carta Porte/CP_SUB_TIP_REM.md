# Tabla: ID: CP_SUB_TIP_REM

## 📄 Información General
- Tipo de tabla: Maestro
- Reside en: Disco
- Longitud del registro: 269
- Número de campos: 4
- Número de índices: 4

## 📝 Descripción [IA]
Esta tabla de catálogo (Subtipo Remolque) provee valores estandarizados por el SAT para el módulo de Carta Porte. Su función es garantizar la integridad referencial y el cumplimiento normativo en la generación de documentos fiscales y registros contables.

## 🛠️ Estructura de Campos

| Identificador | Nombre | Tipo | Longitud | Tipo de enlace | Comentarios y Relaciones |
| :--- | :--- | :--- | :--- | :--- | :--- |
| `ID` | Código | Alfa 256 | 6 |  | Clave primaria y código oficial definido por el SAT para este catálogo. |
