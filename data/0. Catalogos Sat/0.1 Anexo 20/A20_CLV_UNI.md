...
## 📝 Descripción [IA]
Esta tabla de catálogo (Claves de Unidad) provee valores estandarizados por el SAT para el módulo de ANEXO 20. Su función es garantizar la integridad referencial y el cumplimiento normativo en la generación de documentos fiscales y registros contables.
...
| `DESC` | Descripcion | Alfa 256 | 1000 |  | Campo técnico para el almacenamiento de descripcion. |
| `NOTA` | Descripcion | Alfa 256 | 1000 |  | Campo técnico para el almacenamiento de descripcion. |
