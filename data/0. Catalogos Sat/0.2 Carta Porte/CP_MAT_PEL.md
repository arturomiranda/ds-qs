...
## 📝 Descripción [IA]
Catálogo especializado de la Carta Porte que identifica sustancias o artículos que requieren medidas de seguridad especiales durante su transporte.
...
| `CLS` | Clase | Alfa 256 | 256 |  | Campo técnico para el almacenamiento de clase. |
