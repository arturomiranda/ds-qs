...
## 📝 Descripción [IA]
Esta tabla de catálogo (Clave Unidad Peso) provee valores estandarizados por el SAT para el módulo de Carta Porte. Su función es garantizar la integridad referencial y el cumplimiento normativo en la generación de documentos fiscales y registros contables.
...
| `DES` | Descripción | Alfa 256 | 256 |  | Campo técnico para el almacenamiento de descripción. |
| `SIMB` | Símbolo | Alfa 256 | 256 |  | Campo técnico para el almacenamiento de símbolo. |
| `BAND` | Bandera | Alfa 256 | 256 |  | Campo técnico para el almacenamiento de bandera. |
