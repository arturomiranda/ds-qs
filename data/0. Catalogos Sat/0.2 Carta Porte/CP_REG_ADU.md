...
## 📝 Descripción [IA]
Esta tabla de catálogo (Regimen Aduanero) provee valores estandarizados por el SAT para el módulo de Carta Porte. Su función es garantizar la integridad referencial y el cumplimiento normativo en la generación de documentos fiscales y registros contables.
...
| `IMP` | Importación | Booleano | 1 |  | Campo técnico para el almacenamiento de importación. |
| `EXP` | Exportación | Booleano | 1 |  | Campo técnico para el almacenamiento de exportación. |
