...
## 📝 Descripción [IA]
Esta tabla de catálogo (Clave Tipo Estación) provee valores estandarizados por el SAT para el módulo de Carta Porte. Su función es garantizar la integridad referencial y el cumplimiento normativo en la generación de documentos fiscales y registros contables.
...
| :--- | :--- | :--- | :--- |
| `CP_REL_TRA_TIP_EST_EST` | Carta Porte: Tabla | Relación Transporte Tipo Estación CP_REL_TRA_TIP_EST@ catalogos_sat_dat | EST |
