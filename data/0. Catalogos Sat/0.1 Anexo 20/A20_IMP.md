...
## 📝 Descripción [IA]
Esta tabla de catálogo (Impuestos) provee valores estandarizados por el SAT para el módulo de ANEXO 20. Su función es garantizar la integridad referencial y el cumplimiento normativo en la generación de documentos fiscales y registros contables.
...
| `IMP_RET` | Retencion | Booleano | 1 |  | Campo técnico para el almacenamiento de retencion. |
| `IMP_TRA` | Traslado | Booleano | 1 |  | Campo técnico para el almacenamiento de traslado. |
| `LOC_FED` | Nombre | Alfa 256 | 35 |  | Campo técnico para el almacenamiento de nombre. |
