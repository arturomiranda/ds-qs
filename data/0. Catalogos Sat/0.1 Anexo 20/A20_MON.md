...
## 📝 Descripción [IA]
Define las divisas permitidas por el SAT (MXN, USD, EUR, etc.) y su configuración de decimales. Es el eje central para el cálculo de importes en todas las pólizas contables.
...
| `DEC` | Decimales | Numérico | 2 |  | Campo técnico para el almacenamiento de decimales. |
