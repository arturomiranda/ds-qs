# Tabla: ID: A20_FOR_PAG

## 📄 Información General
- Tipo de tabla: Maestro
- Reside en: Disco
- Longitud del registro: 93
- Número de campos: 6
- Número de índices: 4

## 📝 Descripción [IA]
Esta tabla de catálogo (Formas de Pago) provee valores estandarizados por el SAT para el módulo de ANEXO 20. Su función es garantizar la integridad referencial y el cumplimiento normativo en la generación de documentos fiscales y registros contables.
...
| `BANC` | Bancarizado | Alfa 256 | 8 |  | Campo técnico para el almacenamiento de bancarizado. |
| `NUM_OPE` | Número de operación | Alfa 256 | 40 |  | Campo técnico para el almacenamiento de número de operación. |
