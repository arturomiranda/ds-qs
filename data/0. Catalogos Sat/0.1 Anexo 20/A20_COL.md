...
## 📝 Descripción [IA]
Esta tabla de catálogo (Colonias) provee valores estandarizados por el SAT para el módulo de ANEXO 20. Su función es garantizar la integridad referencial y el cumplimiento normativo en la generación de documentos fiscales y registros contables.
...
| `CLV` | Clave | Alfa 256 | 4 |  | Campo técnico para el almacenamiento de clave. |
| `NAME` | Nombre | Alfa 256 | 35 |  | Nombre descriptivo o razón social asociada a la clave. |
| `CP` | Código Postal | Alfa 256 | 5 | Maestro: A20_CP@catalogos_sat_dat | Campo técnico para el almacenamiento de código postal. |
