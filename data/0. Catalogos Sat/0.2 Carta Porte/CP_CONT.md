...
## 📝 Descripción [IA]
Esta tabla de catálogo (Contenedor) provee valores estandarizados por el SAT para el módulo de Carta Porte. Su función es garantizar la integridad referencial y el cumplimiento normativo en la generación de documentos fiscales y registros contables.
...
| `TIP_CONT` | Tipo de contenedor | Alfa 256 | 256 |  | Campo técnico para el almacenamiento de tipo de contenedor. |
