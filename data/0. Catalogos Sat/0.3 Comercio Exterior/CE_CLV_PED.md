...
## 📝 Descripción [IA]
Esta tabla de catálogo (clave de pedimiento) provee valores estandarizados por el SAT para el módulo de Comercio Exterior. Su función es garantizar la integridad referencial y el cumplimiento normativo en la generación de documentos fiscales y registros contables.
