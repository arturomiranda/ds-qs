# Tabla: 003: Impuestos Trasladados

Esta tabla detalla los impuestos trasladados (IVA, IEPS) aplicados a un CFDI, ya sea a nivel global o por concepto.

## 📄 Información General
- **ID de Tabla:** `003_IMP_TRSL`
- **Tipo:** Maestro
- **Reside en:** Disco
- **Longitud del registro:** 43
- **Número de campos:** 7
- **Número de índices:** 2
- **Descripción:** Detalle de impuestos trasladados por comprobante fiscal.
...
- La base (`NUM_BASE`) es el importe sobre el cual se calcula el impuesto trasladado.
