...
## 📝 Descripción [IA]
Define la naturaleza del documento (Ingreso, Egreso, Traslado, Nómina, Pago). Dicta las reglas de validación y el comportamiento contable del documento en el ERP.

## 🛠️ Estructura de Campos

| Identificador | Nombre | Tipo | Longitud | Tipo de enlace | Comentarios y Relaciones |
| :--- | :--- | :--- | :--- | :--- | :--- |
| `ID` | Código | Alfa 256 | 1 |  | Clave primaria y código oficial definido por el SAT para este catálogo. |
