...
## 📝 Descripción [IA]
Esta tabla de catálogo (Registro ISTMO) provee valores estandarizados por el SAT para el módulo de Carta Porte. Su función es garantizar la integridad referencial y el cumplimiento normativo en la generación de documentos fiscales y registros contables.
